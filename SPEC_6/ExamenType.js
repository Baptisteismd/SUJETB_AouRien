...
async function comparerFichiersDExtension(dossier, extension, NomFichier) {
    // Compteur du nombre total de fichiers (sert pour calculer le nb moyen de chaque type de question)
    let nbFichiers = 0;
    ...
    try {
        ...
        for (const fichier of fichiersFiltres) {
            ...
            // Les compteurs totaux vont s'implémenter à la fin de chaque fichier étudié
